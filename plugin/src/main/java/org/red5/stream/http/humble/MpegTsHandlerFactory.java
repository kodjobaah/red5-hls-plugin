...
package org.red5.stream.http.humble;

import java.util.HashMap;
import java.util.Map;

import org.red5.logging.Red5LoggerFactory;
import org.red5.humble.handler.IEventIOHandler;
...
/**
 * Used by HUMBLE.IO to get a new URLProtocolHandler for an mpeg-ts URL.
 * 
...
public class MpegTsHandlerFactory implements IURLProtocolHandlerFactory {
	...
	/**
	 * Get the default factory used by HUMBLE.IO for mpeg-ts streams to
	...
	/**
	 * Register a factory that HUMBLE.IO will use for the given protocol.
	 * 
	...
	/**
	 * Called by HUMBLE.IO to get a a handler for a given URL. The handler
	 ...
	 * When writing IRTMPEvent, we will use whatever MetaData HUMBLE tells us
	 * about the stream.
	 * 
	 * @param handler
